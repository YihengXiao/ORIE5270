...
class TestPrintTree(unittest.TestCase):
    ...
    def test3(self):
        ...
        case3=Node(1, Node(2,Node(None,None,None),Node(5,None,None)), Node(3,Node(4,None,None),Node(None,None,None)))
    ...
    def test4(self):
        # irregular tree
        case4=Node(1, Node(2,Node(3,None,None),None),Node(None,Node(None,None,None),Node(None,None,None)))
